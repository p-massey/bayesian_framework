...
def main():
    ...
    corner_file = os.path.join(plot_dir, f"{base_name}_corner.png")
    fit_file = os.path.join(plot_dir, f"{base_name}_fit.png")
    run_file = os.path.join(plot_dir, f"{base_name}_run.png")
    trace_file = os.path.join(plot_dir, f"{base_name}_trace.png")
